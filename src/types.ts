...
export interface Transaction {
  ...
  savingsGoalId?: string;       // set when transfer is a savings goal contribution
}
...
export type SavingsGoalStatus = 'active' | 'completed' | 'failed';
...
export interface SavingsGoal {
  ...
  currency: Currency;
  deadline: string;        // целевая дата
  completedDates: string[]; // даты когда отмечали выполненным
  createdAt: string;
