...
import type { PlannedExpense, Transaction, Debt, DebtPayment } from "../types";
...
export default function Calendar() {
	...
	const dayOps = useMemo<DayOp[]>(() => {
		...
		const debtPayments: DayOp[] = selectedDebtPayments.map((p) => ({
			kind: "debtPayment",
			payment: p,
			debt: p.debt,
		}));
	...
	return (
		<div className="page-enter pb-32">
			...
			<div className="flex items-center justify-between px-5 pt-6 pb-4">
				...
				<button
					onClick={() =>
						canAddPlannedExpense ? setShowAdd(true) : openPricing()
					}
