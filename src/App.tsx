  ...
  return (
    <BrowserRouter>
      ...
      <div className="min-h-screen" style={{ background: '#07070F' }}>
        ...
        <Suspense fallback={
          <div style={{ height: '100vh', background: '#07070F', padding: '1.5rem' }}>
            <div style={{ height: '1.5rem', width: '40%', borderRadius: 12, background: '#1E1E38', marginBottom: '1.25rem', animation: 'pulse 1.5s ease-in-out infinite' }} />
            <div style={{ height: '10rem', borderRadius: 20, background: '#1E1E38', marginBottom: '1rem', animation: 'pulse 1.5s ease-in-out infinite' }} />
            <div style={{ height: '6rem', borderRadius: 20, background: '#1E1E38', marginBottom: '1rem', animation: 'pulse 1.5s ease-in-out infinite' }} />
            <div style={{ height: '6rem', borderRadius: 20, background: '#1E1E38', animation: 'pulse 1.5s ease-in-out infinite' }} />
          </div>
        }>
          <Routes>
