...
export default function TransactionForm({
	...
	const [date, setDate] = useState(
		editingTx?.date ?? initialDate ?? format(new Date(), "yyyy-MM-dd"),
	);
		...
		<div className="px-5 pb-8 space-y-5">
			...
			{showRecurring && (
				<div>
					...
					>
						...
						<div className="flex-1 text-left">
							<p
								...
								style={{ color: isRecurring ? "#C7D2FE" : "#94A3B8" }}
							>
								{language === "ru"
					...
					{isRecurring && (
						<div
							className="mt-3 space-y-3 p-4 rounded-2xl"
											...
											style={{
												background:
													recurFrequency === opt.value
														...
														: "transparent",
												color:
													recurFrequency === opt.value ? "#818CF8" : "#64748B",
												border:
													recurFrequency === opt.value
														? "1px solid #6366F140"
